package com.combatreforged.metis.builder.mixin._bugfixes;
...
public class PacketUtilsMixin {
     ...
     * Courtesy of <a href="https://hub.spigotmc.org/stash/projects/SPIGOT/repos/craftbukkit/browse/nms-patches/net/minecraft/network/protocol/PlayerConnectionUtils.patch">Spigot Patch</a>
     * @author rizecookey
